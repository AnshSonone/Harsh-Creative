...
const Navbar = () => {
  ...
  return (
    <div className='flex flex-col md:flex-row items-center md:items-start md:justify-between justify-center px-10'>
      ...
      <div className={`absolute ${show} bg-[#4545c7]/40 backdrop-blur-xs z-10 space-y-10 flex flex-col items-center justify-center py-6 w-full h-[50%] transition-all ease-in-out delay-150 duration-200 md:flex-row md:relative md:bg-transparent md:items-start md:justify-between`}>
